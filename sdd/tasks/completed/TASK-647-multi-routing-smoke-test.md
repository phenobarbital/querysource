...
**Date**: 2026-05-20
**Notes**: Created tests/test_scheduler_multi_routing.py with two hermetic tests
(no live DB). Used MagicMock for the APScheduler. Both tests pass.
Full scheduler suite (38 tests) passes with no regressions.
