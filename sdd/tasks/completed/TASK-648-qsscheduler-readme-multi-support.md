...
**Date**: 2026-05-20
**Notes**: Created docs/QSSCHEDULER.md with all six sections: Overview, Job kinds table,
Scheduling a single query, Scheduling a multi-query, Reserved JSON sub-key, Misconfiguration
WARN, and Configuration flags. README.md left untouched (no docs/links section found).
Document is under 120 lines. Matches the behaviors implemented in TASK-644/645/646.
