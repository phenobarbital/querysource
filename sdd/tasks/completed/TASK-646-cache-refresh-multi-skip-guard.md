...
**Date**: 2026-05-20
**Notes**: Added one-line guard `if row.get("provider") == "multi": continue` at the
top of the for-row loop in _load_cache_refresh_jobs, before slug extraction.
Added 2 unit tests. All 20 tests in test_scheduler_core.py pass. No linting errors.
