...
**Date**: 2026-05-20
**Notes**: Implemented `scheduled_multiqs_job` as a near-line-for-line twin of
`scheduled_query_job`, swapping QS for MultiQS and the job-id prefix.
Lazy-import pattern preserved. Module docstring updated to describe three job kinds.
All 3 new unit tests pass; 11 total tests pass. No linting errors.
