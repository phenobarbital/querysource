"""Unit tests for SmartSheetSource (TASK-648)."""
import asyncio
import io
...
from querysource.queries.multi.sources.smartsheet import SmartSheetSource
...
class TestSmartSheetSource:
    def test_inherits_thread_source(self):
        assert issubclass(SmartSheetSource, ThreadSource)

    def test_parses_config(self):
        options = {"source": {"file_id": 12345}}
        source = SmartSheetSource("ss_test", options, None, asyncio.Queue())
    ...
    def test_explicit_api_key(self):
        ...
        source = SmartSheetSource("ss", options, None, asyncio.Queue())
